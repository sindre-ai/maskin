...
- `components/activity/` — ActivityComment, ActivityItem, ActionBanner, PhaseDivider, RelationshipNode, CommentInput, UndoWriteChip, PendingCommentRow, MentionSessionCard, StreamingIndicator.
