...
// ── Conversations ──────────────────────────────────────────────────────────
//
// Named, resumable threads. type='dm' is a direct message between two actors;
// type='room' supports multiple participants. Sessions remain ephemeral
// execution units — they belong to a conversation but are not the conversation.
