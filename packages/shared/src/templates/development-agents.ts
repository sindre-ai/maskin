...
Commitments live alongside bets as a first-class object type. Do not confuse a Commitment with a bet in \`live\` — a bet is a time-boxed wager with an end date; a Commitment has no end date and no verdict, only a floor and a cadence that hold indefinitely.
