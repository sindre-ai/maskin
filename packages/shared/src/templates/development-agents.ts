		...
		skills: [
			{
				...
				// This body is a verbatim mirror of .agents/skills/workspace-observer-onboarding/SKILL.md —
				// update both files together (the seed loop reads from here; the skill file is the
				// canonical human-readable copy).
				content: `---
name: workspace-observer-onboarding
