// Canonical source-item IDs for the Consulting workspace marketplace loops.
// These are the IDs of the actors in a live solo-consultancy workspace. All
...
export const CONSULTING_SOURCE_WORKSPACE_ID = '369d2e23-d76c-4c71-807e-ab1698f18b1c'

// ── Actor IDs ────────────────────────────────────────────────────────────────

export const CONSULTING_ACTOR_GIG_SCOUT = 'f64a5297-b422-4e35-a99d-9ec17526bc04'
export const CONSULTING_ACTOR_JOB_APPLICANT = '60e39163-ea7d-4774-b87b-a9158d55481e'
export const CONSULTING_ACTOR_INBOX_SCOUT = 'cd359acc-0ba1-40c4-823d-0704212385b5'
...
export const CONSULTING_LOOP_USE_CASE_CONSULTING = 'Consulting'
...
export const CONSULTING_LOOP_GIG_SLUG = 'gig-loop'
export const CONSULTING_LOOP_GIG_NAME = 'Gig Loop'
export const CONSULTING_LOOP_GIG_DESCRIPTION =
