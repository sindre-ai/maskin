// Canonical source-item IDs for the Discover & Research Loop marketplace loop.
...
// the publish script — import from here so a loop actor/trigger ID is only
...
export const CCD_LOOP_SLUG = 'discover-research-loop'
export const CCD_LOOP_NAME = 'Discover & Research Loop'
export const CCD_LOOP_VERSION = '1.0.0'
export const CCD_LOOP_USE_CASE = 'Discovery'
export const CCD_LOOP_DESCRIPTION =
