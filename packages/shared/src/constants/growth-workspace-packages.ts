// Canonical source-item IDs for the Growth Workspace catalog packages.
// These are the IDs of the actors in Maskin's live Growth workspace
// (2b95807b-26f8-424c-8e35-8bee8ed57f7d). All package configs import from here
...
// `skillIdsForActor` in ./catalog-packages/package-data (mirrors the
// dev-workspace-packages.ts pattern).
...
// ── Use cases ────────────────────────────────────────────────────────────────
// 'Growth' and 'Operations' already exist (see dev-workspace-packages.ts);
// 'Sales' and 'Marketing' are new — the marketplace derives its use-case
// filter chips from whatever distinct values are present in the catalog, so
// no other registration is required.

export const GROWTH_PACKAGE_USE_CASE_SALES = 'Sales'
export const GROWTH_PACKAGE_USE_CASE_MARKETING = 'Marketing'
...
export const GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_SLUG = 'lead-gen-qualification-loop'
export const GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_NAME = 'Lead Gen & Qualification Loop'
export const GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_SDR_OUTREACH_LOOP_SLUG = 'sdr-outreach-loop'
export const GROWTH_PACKAGE_SDR_OUTREACH_LOOP_NAME = 'SDR Outreach Loop'
export const GROWTH_PACKAGE_SDR_OUTREACH_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_DEAL_RELATIONSHIP_LOOP_SLUG = 'deal-relationship-loop'
export const GROWTH_PACKAGE_DEAL_RELATIONSHIP_LOOP_NAME = 'Deal & Relationship Loop'
export const GROWTH_PACKAGE_DEAL_RELATIONSHIP_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_SLUG = 'content-insight-loop'
export const GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_NAME = 'Content & Insight Loop'
export const GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_BRAND_DEMAND_LOOP_SLUG = 'brand-demand-loop'
export const GROWTH_PACKAGE_BRAND_DEMAND_LOOP_NAME = 'Brand & Demand Loop'
export const GROWTH_PACKAGE_BRAND_DEMAND_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_GROWTH_BET_LOOP_SLUG = 'growth-bet-loop'
export const GROWTH_PACKAGE_GROWTH_BET_LOOP_NAME = 'Growth Bet Loop'
export const GROWTH_PACKAGE_GROWTH_BET_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_OPS_KNOWLEDGE_LOOP_SLUG = 'ops-knowledge-loop'
export const GROWTH_PACKAGE_OPS_KNOWLEDGE_LOOP_NAME = 'Ops & Knowledge Loop'
export const GROWTH_PACKAGE_OPS_KNOWLEDGE_LOOP_DESCRIPTION =
...
export const GROWTH_PACKAGE_MEETING_LOOP_SLUG = 'meeting-loop'
export const GROWTH_PACKAGE_MEETING_LOOP_NAME = 'Meeting Loop'
export const GROWTH_PACKAGE_MEETING_LOOP_DESCRIPTION =
