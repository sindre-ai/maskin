...
[![CI](https://img.shields.io/github/actions/workflow/status/vaerksted-ai/maskin/ci.yml?label=CI)](https://github.com/vaerksted-ai/maskin/actions/workflows/ci.yml)
[![GitHub Stars](https://img.shields.io/github/stars/vaerksted-ai/maskin?style=flat)](https://github.com/vaerksted-ai/maskin/stargazers)
...
```
Clone https://github.com/vaerksted-ai/maskin, cd into it, follow the "Onboarding a new user from Claude Code" section of CLAUDE.md, and hand off to the get_started MCP tool.
```
...
```bash
# Clone and install
git clone https://github.com/vaerksted-ai/maskin.git && cd maskin
pnpm install
