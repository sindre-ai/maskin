...
//      `linkedin_send_message` expects on the autosend path (per parent
...
// yet in this repo) linkedin_send_message tool handler so the caller — the
...
// to `linkedin_send_message` for the same (contact, draft) pair will hash
