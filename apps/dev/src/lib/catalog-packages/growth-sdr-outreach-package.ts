// Shared constants for the SDR Outreach Loop catalog bundle.
//
...
import {
	...
	GROWTH_PACKAGE_SDR_OUTREACH_LOOP_DESCRIPTION,
	GROWTH_PACKAGE_SDR_OUTREACH_LOOP_NAME,
	GROWTH_PACKAGE_SDR_OUTREACH_LOOP_SLUG,
...
export const GROWTH_SDR_OUTREACH_PACKAGE = {
	slug: GROWTH_PACKAGE_SDR_OUTREACH_LOOP_SLUG,
	name: GROWTH_PACKAGE_SDR_OUTREACH_LOOP_NAME,
	version: DEV_PACKAGE_VERSION,
	useCase: GROWTH_PACKAGE_USE_CASE_SALES,
	description: GROWTH_PACKAGE_SDR_OUTREACH_LOOP_DESCRIPTION,
} as const
