// Shared constants for the Growth Bet Loop catalog bundle.
//
...
import {
	...
	GROWTH_PACKAGE_GROWTH_BET_LOOP_DESCRIPTION,
	GROWTH_PACKAGE_GROWTH_BET_LOOP_NAME,
	GROWTH_PACKAGE_GROWTH_BET_LOOP_SLUG,
...
export const GROWTH_BET_PACKAGE = {
	slug: GROWTH_PACKAGE_GROWTH_BET_LOOP_SLUG,
	name: GROWTH_PACKAGE_GROWTH_BET_LOOP_NAME,
	version: DEV_PACKAGE_VERSION,
	useCase: DEV_PACKAGE_USE_CASE_GROWTH,
	description: GROWTH_PACKAGE_GROWTH_BET_LOOP_DESCRIPTION,
} as const
