// Shared constants for the Lead Gen & Qualification Loop catalog bundle.
//
...
import {
	...
	GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_DESCRIPTION,
	GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_NAME,
	GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_SLUG,
...
export const GROWTH_LEAD_GEN_PACKAGE = {
	slug: GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_SLUG,
	name: GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_NAME,
	version: DEV_PACKAGE_VERSION,
	useCase: GROWTH_PACKAGE_USE_CASE_SALES,
	description: GROWTH_PACKAGE_LEAD_GEN_QUALIFICATION_LOOP_DESCRIPTION,
} as const
