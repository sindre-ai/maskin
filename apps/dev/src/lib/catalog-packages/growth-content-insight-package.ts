// Shared constants for the Content & Insight Loop catalog bundle.
//
...
import {
	...
	GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_DESCRIPTION,
	GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_NAME,
	GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_SLUG,
...
export const GROWTH_CONTENT_INSIGHT_PACKAGE = {
	slug: GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_SLUG,
	name: GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_NAME,
	version: DEV_PACKAGE_VERSION,
	useCase: GROWTH_PACKAGE_USE_CASE_MARKETING,
	description: GROWTH_PACKAGE_CONTENT_INSIGHT_LOOP_DESCRIPTION,
} as const
