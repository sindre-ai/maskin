// Shared constants for the Meeting Loop catalog bundle.
//
...
import {
	...
	GROWTH_PACKAGE_MEETING_LOOP_DESCRIPTION,
	GROWTH_PACKAGE_MEETING_LOOP_NAME,
	GROWTH_PACKAGE_MEETING_LOOP_SLUG,
...
export const GROWTH_MEETING_PACKAGE = {
	slug: GROWTH_PACKAGE_MEETING_LOOP_SLUG,
	name: GROWTH_PACKAGE_MEETING_LOOP_NAME,
	version: DEV_PACKAGE_VERSION,
	useCase: DEV_PACKAGE_USE_CASE_OPERATIONS,
	description: GROWTH_PACKAGE_MEETING_LOOP_DESCRIPTION,
} as const
