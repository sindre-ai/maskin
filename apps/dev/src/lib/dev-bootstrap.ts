...
} from './catalog-packages/growth-content-insight-package'
import {
...
const CATALOG_SEED_CONFIGS: readonly CatalogPackageSeedConfig[] = [
	...
	{
		package: GROWTH_CONTENT_INSIGHT_PACKAGE,
	...
	{
		package: GROWTH_MEETING_PACKAGE,
