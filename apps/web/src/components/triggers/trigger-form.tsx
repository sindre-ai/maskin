	...
	return (
		<div className="space-y-3">
			...
			<textarea
				...
				rows={1}
				className="w-full text-2xl font-semibold tracking-tight bg-transparent border-none outline-none text-foreground mb-2 resize-none overflow-hidden p-0 focus:outline-none"
				ref={(el) => {
					if (el) {
