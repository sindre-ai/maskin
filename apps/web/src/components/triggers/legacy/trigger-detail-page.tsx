/**
 * Pre-v2 trigger-detail-page, restored verbatim from the route body it lived in before the
...
import { TriggerForm } from '@/components/triggers/legacy/trigger-form'
import type { TriggerFormPayload } from '@/components/triggers/legacy/trigger-form'
...
export function LegacyTriggerDetailPage({ triggerId }: { triggerId: string }) {
