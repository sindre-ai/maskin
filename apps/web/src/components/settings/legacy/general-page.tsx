// PRE-V2 SETTINGS → GENERAL PAGE — governed by the `new-design` feature flag.
//
// The route (`routes/_authed/$workspaceId/settings/index.tsx`) renders this whenever `new-design` is off;
...
export function LegacyGeneralPage() {
