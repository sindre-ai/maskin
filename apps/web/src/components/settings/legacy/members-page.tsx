// PRE-V2 SETTINGS → MEMBERS PAGE — governed by the `new-design` feature flag.
//
// The route (`routes/_authed/$workspaceId/settings/members.tsx`) renders this whenever `new-design` is off;
// the v2 page renders when it is on. This whole directory dies with the flag —
...
export function LegacyMembersPage() {
