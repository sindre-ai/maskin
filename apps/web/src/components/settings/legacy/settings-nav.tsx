...
// PRE-V2 SETTINGS NAV — governed by the `new-design` feature flag.
//
// The Settings layout route (`routes/_authed/$workspaceId/settings.tsx`)
// renders this whenever `new-design` is off; the v2 nav renders when it is on.
// This whole directory dies with the flag — see `.claude/rules/feature-flags.md`.
...
const settingsNav = [
	...
	{ label: 'Billing', to: '/$workspaceId/settings/keys' as const },
	{ label: 'MCP', to: '/$workspaceId/settings/mcp' as const },
]

export function LegacySettingsNav() {
