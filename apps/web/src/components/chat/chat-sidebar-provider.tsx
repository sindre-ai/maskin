...
/**
 * Fork of shadcn's `SidebarProvider` scoped to the chat right-side panel.
 ...
 */
export const ChatSidebarProvider = React.forwardRef<
	HTMLDivElement,
...
>(({ open, onOpenChange, className, style, children, ...props }, ref) => {
	...
	// on mobile the chat panel should look and behave exactly like on
