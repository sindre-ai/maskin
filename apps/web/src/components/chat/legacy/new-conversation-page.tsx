// PRE-V2 NEW CHAT — governed by the `new-design` feature flag. The route
// (`routes/_authed/$workspaceId/chats/new.tsx`) renders it whenever `new-design`
// is off; the v2 page renders when it's on. This directory dies with the flag —
// edit the v2 page instead.
...
export function LegacyNewConversationPage() {
	const { workspaceId } = useWorkspace()
	const search = useSearch({ from: '/_authed/$workspaceId/chats/new' })
