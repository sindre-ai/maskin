...
/**
 * Pre-v2 "New chat" page, restored verbatim from before the v2 Chats redesign.
 * Rendered when the `new-design` flag is OFF — see
 * `routes/_authed/$workspaceId/chats/new.tsx` for the branch. This whole
 * directory dies with that flag (`.claude/rules/feature-flags.md`).
 */
...
export function LegacyNewConversationPage({ search }: { search: NewChatSearch }) {
