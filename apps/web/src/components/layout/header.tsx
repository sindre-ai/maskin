...
export function Header() {
	...
	return (
		<header className="relative flex h-11 shrink-0 items-center gap-2 after:pointer-events-none after:absolute after:top-full after:right-0 after:left-0 after:z-10 after:h-4 md:after:h-8 after:bg-gradient-to-b after:from-background after:to-transparent after:content-['']">
