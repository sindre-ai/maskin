...
export function Header() {
	...
	return (
		<header className="relative flex min-h-11 shrink-0 items-center gap-2 pt-[var(--safe-area-inset-top)] after:pointer-events-none after:absolute after:top-full after:right-0 after:left-0 after:z-10 after:h-8 after:bg-gradient-to-b after:from-background after:to-transparent after:content-['']">
