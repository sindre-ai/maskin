...
export function ActionBanner({ events, workspaceId: _workspaceId }: ActionBannerProps) {
	...
	return (
		<div
			className={cn(
				'sticky top-0 z-10',
				'-mt-4 -mx-4 md:-mt-8 md:-mx-8 mb-6 px-4 md:px-8 pt-3 pb-3',
...
function DecisionPill({
	...
	return (
		<div className="inline-flex items-center gap-1.5 rounded-full border border-border bg-background px-2.5 py-1 text-xs">
