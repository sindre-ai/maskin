	...
	return (
		<div className="rounded-md border border-border bg-background text-xs">
			<button
				type="button"
				onClick={() => setOpen((v) => !v)}
				className="flex w-full items-center gap-1.5 px-2 py-1.5 min-w-0 text-left text-foreground hover:bg-accent cursor-pointer"
				aria-expanded={open}
			>
				{open ? (
			...
			{open && (
				<pre className="overflow-x-auto border-t border-border px-3 py-2 font-mono text-foreground text-xs whitespace-pre-wrap break-words">
	...
	return (
		<div className="rounded-md border border-border bg-background text-xs">
			<button
				type="button"
				onClick={() => setOpen((v) => !v)}
				className="flex w-full items-center gap-1.5 px-2 py-1.5 text-left text-foreground italic hover:bg-accent cursor-pointer"
				aria-expanded={open}
			>
				{open ? (
