	...
	return (
		<div className="max-w-3xl mx-auto">
			...
			<textarea
				...
				autoFocus
				rows={1}
				className="w-full text-2xl font-bold tracking-tight bg-transparent border border-transparent rounded-md outline-none text-foreground mb-2 resize-none overflow-hidden p-0 hover:border-border focus-visible:ring-2 focus-visible:ring-ring/40"
				ref={(el) => {
					if (el) {
