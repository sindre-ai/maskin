	...
	return (
		<div className="rounded-lg border border-border bg-card transition-colors hover:border-border-strong">
			...
			<div
				...
				className="flex items-center gap-3 p-4 cursor-pointer hover:bg-muted rounded-lg"
			>
				{skill.isFolder && (
					<ChevronRight
						size={14}
				...
				<div className="flex-1 min-w-0">
					<div className="flex items-center gap-2 flex-wrap">
						...
						{skill.isFolder && (
							<span
								className="shrink-0 inline-flex items-center gap-1 rounded-md bg-muted px-1.5 py-0.5 text-xs text-muted-foreground"
