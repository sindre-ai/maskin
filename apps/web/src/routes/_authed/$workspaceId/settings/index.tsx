...
// Extensions are no longer configured here. A workspace enables one by
// installing the matching module loop from the marketplace (Work Module,
// Knowledge Module, CRM Module) — the same install path as agents, skills and
// triggers. Object types contributed by an enabled extension are still
// configurable under Settings → Objects.
