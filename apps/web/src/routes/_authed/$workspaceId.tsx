 ...
 *
 * Padding is symmetric at every viewport: the small-viewport shell has no
 * bottom-anchored chrome to clear, so the narrow gutters simply scale up to
 * the desktop `p-8` at md+.
 */
